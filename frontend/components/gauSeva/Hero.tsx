...
//   return (
//     <section className="relative mt-[80px] h-[80vh] flex items-center justify-center bg-[#130B07] text-white overflow-hidden px-4 sm:px-6 lg:px-8 selection:bg-[#D4A017] selection:text-[#130B07]">
...
export default function GauSevaHero({ banners = [] }: { banners: Banner[] }) {
  ...
  return (
    <section className="mt-[80px] relative h-[30dvh] sm:h-[50dvh] lg:h-[80vh] w-full flex items-center justify-center overflow-hidden">
      {/* BACKGROUND LAYER */}
