...
//         {/* <img
//           src="/images/Hero-section-image-shri-brajrajji-maharaj.webp"
//           alt="Maharaj Ji Banner"
//           className="w-full h-full object-cover opacity-40"
//         /> */}
//         <div className="absolute inset-0 bg-gradient-to-b from-[#1a0800]/50 via-[#3d0f00]/40 to-[#1a0800]"></div>
//       </div>
