...
const Hero = ({ banners = [] } : { banners: Banner[] }) => {
  ...
  return (
    <section className="w-full mt-20 relative h-[30dvh] sm:h-[50dvh] lg:h-[80vh] flex items-center justify-center bg-[#130B07]/20 text-white overflow-hidden px-4 sm:px-6 lg:px-8 selection:bg-[#D4A017] selection:text-[#130B07]">
